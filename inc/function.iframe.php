...
function mostrar_iframe_grupo($iframe_id, $groups_id){
   ...
   // Funci�n monta las pesta�as con los IFRAMES visibles.
...
return $cabecera.$body;
  ...
  // Funci�n que obtiene los IDs de los iframes activos y con permisos individual de usuario o por grupo
